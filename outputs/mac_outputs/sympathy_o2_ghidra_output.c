...
LAB_100003970:
  ...
  if (local_1474 == 2) {
    ...
    _fflush(*(FILE **)puVar1);
    _scanf("%s");
    pcVar8 = _strstr(local_270 + 0x100,"..");
    if (pcVar8 != (char *)0x0) {
      uVar9 = 1;
      uVar10 = _fwrite("Unsafe pattern detected!\n",0x19,1,*(FILE **)PTR____stderrp_100004018);
      goto LAB_100003c14;
    }
      ...
      if (local_270[0x101] == '\0') {
        ...
        do {
          pvVar6 = _memchr("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",
                           (int)local_270[uVar11 + 0x100],0x41);
          if (pvVar6 != (void *)0x0) {
            ...
            if ((int)uVar7 < 2) {
              ...
              local_270[uVar10] = (char)((int)uVar4 >> (uVar7 - 2 & 0x1f));
              uVar10 = uVar10 + 1;
              uVar7 = uVar7 - 2;
            }
          }
        } while ((uVar11 < sVar5) && (uVar11 = uVar11 + 1, uVar10 < 0x100));
      }
      local_270[uVar10] = '\0';
      if (_debug != 0) {
